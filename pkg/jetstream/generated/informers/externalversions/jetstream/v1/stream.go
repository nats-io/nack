	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamV1().Streams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamV1().Streams(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamv1.Stream{},
		resyncPeriod,
...
func (f *streamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamv1.Stream{}, f.defaultInformer)
}

func (f *streamInformer) Lister() v1.StreamLister {
	return v1.NewStreamLister(f.Informer().GetIndexer())
}
