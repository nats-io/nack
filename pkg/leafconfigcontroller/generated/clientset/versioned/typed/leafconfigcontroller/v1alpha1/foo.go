...
import (
	...
	scheme "github.com/nats-io/nack/pkg/leafconfigcontroller/generated/clientset/versioned/scheme"
...
func newFoos(c *LeafconfigcontrollerV1alpha1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
