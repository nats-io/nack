	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamcontrollerV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamcontrollerV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamcontrollerv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamcontrollerv1alpha1.Foo{}, f.defaultInformer)
}
