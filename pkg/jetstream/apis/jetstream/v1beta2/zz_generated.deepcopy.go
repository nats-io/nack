...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamSourceConsumer) DeepCopyInto(out *StreamSourceConsumer) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamSourceConsumer.
func (in *StreamSourceConsumer) DeepCopy() *StreamSourceConsumer {
	if in == nil {
		return nil
	}
	out := new(StreamSourceConsumer)
