...
import (
	...
	scheme "github.com/nats-io/nack/pkg/jetstreamcontroller/generated/clientset/versioned/scheme"
...
func newStreams(c *JetstreamcontrollerV1alpha1Client, namespace string) *streams {
	return &streams{
		client: c.RESTClient(),
		ns:     namespace,
	}
