...
[![Version](https://d25lcipzij17d.cloudfront.net/badge.svg?id=go&type=5&v=0.8.0)](https://github.com/nats-io/nack/releases/tag/v0.8.0)
...
```sh
$ kubectl apply -f https://raw.githubusercontent.com/nats-io/nack/v0.8.0/deploy/crds.yml
```
