...
type FakeFoos struct {
	Fake *FakeLeafconfigcontrollerV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "leafconfigcontroller.nats.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "leafconfigcontroller.nats.io", Version: "v1alpha1", Kind: "Foo"}
