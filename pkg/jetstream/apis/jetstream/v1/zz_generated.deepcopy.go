...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamCredentials) DeepCopyInto(out *StreamCredentials) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamCredentials.
func (in *StreamCredentials) DeepCopy() *StreamCredentials {
	if in == nil {
		return nil
	}
	out := new(StreamCredentials)
	in.DeepCopyInto(out)
	return out
}
