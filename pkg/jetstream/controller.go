...
import (
	...
	jsapiv1 "github.com/nats-io/nack/pkg/jetstream/apis/jetstream/v1"
	jsk8sclient "github.com/nats-io/nack/pkg/jetstream/generated/clientset/versioned"
...
func (c *Controller) Run(ctx context.Context) error {
	...
	streams, err := c.jsc.JetstreamV1().Streams("default").List(ctx, v1.ListOptions{})
	if err != nil {
