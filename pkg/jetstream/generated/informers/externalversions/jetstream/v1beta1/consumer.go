	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamV1beta1().Consumers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamV1beta1().Consumers(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamv1beta1.Consumer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *consumerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamv1beta1.Consumer{}, f.defaultInformer)
}

func (f *consumerInformer) Lister() v1beta1.ConsumerLister {
	return v1beta1.NewConsumerLister(f.Informer().GetIndexer())
}
