	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamV1beta1().Streams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamV1beta1().Streams(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamv1beta1.Stream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *streamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamv1beta1.Stream{}, f.defaultInformer)
}

func (f *streamInformer) Lister() v1beta1.StreamLister {
	return v1beta1.NewStreamLister(f.Informer().GetIndexer())
}
