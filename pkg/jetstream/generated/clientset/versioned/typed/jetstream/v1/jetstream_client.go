...
func NewForConfig(c *rest.Config) (*JetstreamV1Client, error) {
	config := *c
	...
	return &JetstreamV1Client{client}, nil
}

// NewForConfigOrDie creates a new JetstreamV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *JetstreamV1Client {
...
// New creates a new JetstreamV1Client for the given RESTClient.
func New(c rest.Interface) *JetstreamV1Client {
	return &JetstreamV1Client{c}
}
...
func (c *JetstreamV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
