...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamSubjectMapping) DeepCopyInto(out *StreamSubjectMapping) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamSubjectMapping.
func (in *StreamSubjectMapping) DeepCopy() *StreamSubjectMapping {
	if in == nil {
		return nil
	}
	out := new(StreamSubjectMapping)
