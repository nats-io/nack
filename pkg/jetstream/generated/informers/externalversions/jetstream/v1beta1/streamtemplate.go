...
import (
	...
	jetstreamv1beta1 "github.com/nats-io/nack/pkg/jetstream/apis/jetstream/v1beta1"
	...
	v1beta1 "github.com/nats-io/nack/pkg/jetstream/generated/listers/jetstream/v1beta1"
...
type StreamTemplateInformer interface {
	...
	Lister() v1beta1.StreamTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamV1beta1().StreamTemplates(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamV1beta1().StreamTemplates(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamv1beta1.StreamTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *streamTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamv1beta1.StreamTemplate{}, f.defaultInformer)
}

func (f *streamTemplateInformer) Lister() v1beta1.StreamTemplateLister {
	return v1beta1.NewStreamTemplateLister(f.Informer().GetIndexer())
}
