...
import (
	...
	leafconfigcontrollerv1alpha1 "github.com/nats-io/nack/pkg/leafconfigcontroller/apis/leafconfigcontroller/v1alpha1"
	versioned "github.com/nats-io/nack/pkg/leafconfigcontroller/generated/clientset/versioned"
	internalinterfaces "github.com/nats-io/nack/pkg/leafconfigcontroller/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/nats-io/nack/pkg/leafconfigcontroller/generated/listers/leafconfigcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LeafconfigcontrollerV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LeafconfigcontrollerV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&leafconfigcontrollerv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&leafconfigcontrollerv1alpha1.Foo{}, f.defaultInformer)
}
