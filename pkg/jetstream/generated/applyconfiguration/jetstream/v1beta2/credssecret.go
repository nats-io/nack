...
// CredsSecretApplyConfiguration represents an declarative configuration of the CredsSecret type for use
// with apply.
...
// CredsSecretApplyConfiguration constructs an declarative configuration of the CredsSecret type for use with
// apply.
