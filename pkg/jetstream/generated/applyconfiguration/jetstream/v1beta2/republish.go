...
// RePublishApplyConfiguration represents an declarative configuration of the RePublish type for use
// with apply.
...
// RePublishApplyConfiguration constructs an declarative configuration of the RePublish type for use with
// apply.
