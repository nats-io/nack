...
import (
	...
	jetstreamcontrollerv1alpha1 "github.com/nats-io/nack/pkg/jetstreamcontroller/apis/jetstreamcontroller/v1alpha1"
	versioned "github.com/nats-io/nack/pkg/jetstreamcontroller/generated/clientset/versioned"
	internalinterfaces "github.com/nats-io/nack/pkg/jetstreamcontroller/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/nats-io/nack/pkg/jetstreamcontroller/generated/listers/jetstreamcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.JetstreamcontrollerV1alpha1().Streams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JetstreamcontrollerV1alpha1().Streams(namespace).Watch(context.TODO(), options)
			},
		},
		&jetstreamcontrollerv1alpha1.Stream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *streamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jetstreamcontrollerv1alpha1.Stream{}, f.defaultInformer)
}
